...
// insert-if-snippet -> insert-for-snippet -> insert-if-snippet -> insert-for-snippet -> insert-if-snippet -> insert-assignment-snippet

int main(void)
{
  platform_main_begin();
  crc32_gentab();
  volatile int S2CViBN6 = 1430050542;
  int PQ3j2kU6 = 2147483647;
  int tUkPDh8c = 2147483647;
  char nT3ox8kK = (signed char)-19;
  char rqYftoV2 = (signed char)127;
  char polFLhPH = (signed char)8;
  int lnRD5e7B = 2147483647;
  ...
  transparent_crc(lnRD5e7B, "lnRD5e7B", 1);
  transparent_crc(polFLhPH, "polFLhPH", 1);
  transparent_crc(rqYftoV2, "rqYftoV2", 1);
  transparent_crc(nT3ox8kK, "nT3ox8kK", 1);
  transparent_crc(tUkPDh8c, "tUkPDh8c", 1);
  transparent_crc(PQ3j2kU6, "PQ3j2kU6", 1);
  transparent_crc(S2CViBN6, "S2CViBN6", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  if (""['\0'])
  {
    if (tUkPDh8c)
      lnRD5e7B = (rqYftoV2) ? (polFLhPH) : (nT3ox8kK);
