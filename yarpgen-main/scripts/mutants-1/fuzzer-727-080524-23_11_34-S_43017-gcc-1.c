...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int ylHovPAB = 999709111;
  int Q8MCDrIh = 2147483647;
  int v4mVGZAb = -2147483648;
  int PR2GwVSc = 603943495;
  int Wm0nxurA = -2147483648;
  ...
  transparent_crc(Wm0nxurA, "Wm0nxurA", 1);
  transparent_crc(PR2GwVSc, "PR2GwVSc", 1);
  transparent_crc(v4mVGZAb, "v4mVGZAb", 1);
  transparent_crc(Q8MCDrIh, "Q8MCDrIh", 1);
  transparent_crc(ylHovPAB, "ylHovPAB", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
