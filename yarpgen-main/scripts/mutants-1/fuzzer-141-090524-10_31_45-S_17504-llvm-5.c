...
// insert-if-snippet -> insert-switch-snippet -> insert-while-snippet -> insert-for-snippet -> insert-while-snippet -> insert-assignment-snippet
...
{
  int  RM6_1ILk = 1126140984;
  int * WDIzQwrd = &RM6_1ILk;
  unsigned short tUOvRyP1 = (unsigned short)65535;
  unsigned int eqOFvMwJ = 3847825723U;
  transparent_crc(eqOFvMwJ, "eqOFvMwJ", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  *WDIzQwrd = tUOvRyP1 | eqOFvMwJ;
  transparent_crc(tUOvRyP1, "tUOvRyP1", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return p1 + p2;
}
