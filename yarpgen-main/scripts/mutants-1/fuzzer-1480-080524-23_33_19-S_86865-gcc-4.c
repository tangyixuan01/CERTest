...
void bt(void)
{
  volatile int WIx3AX7c = 2147483647;
  int exE5O1XB = -2147483648;
  for (xy = 0; xy >= 0; --xy)
  {
    int yt[8] = {0};
    int pz[2] = {0};
  ...
  transparent_crc(exE5O1XB, "exE5O1XB", 1);
  transparent_crc(WIx3AX7c, "WIx3AX7c", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  tb = 1;
}
...
int main(void)
{
  platform_main_begin();
  crc32_gentab();
  int Cs03geKt = -2147483648;
  int  EBgHIiDx = 2147483647;
  int * ngMCFkoR = &EBgHIiDx;
  unsigned char QOtJf0jN = (unsigned char)38;
  ...
  transparent_crc(QOtJf0jN, "QOtJf0jN", 1);
  transparent_crc(Cs03geKt, "Cs03geKt", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
