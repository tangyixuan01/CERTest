...
// insert-for-snippet -> insert-while-snippet -> insert-if-snippet -> insert-for-snippet -> insert-switch-snippet
...
int main()
{
  ...
  transparent_crc(alLwO87v, "alLwO87v", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
