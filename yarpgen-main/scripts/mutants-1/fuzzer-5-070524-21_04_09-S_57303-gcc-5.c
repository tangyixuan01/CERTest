...
// insert-while-snippet -> insert-switch-snippet -> insert-while-snippet -> insert-while-snippet -> insert-if-snippet -> insert-while-snippet
...
{
  int  fsPLAwTX = -2147483648;
  int * pJlEPLmi = &fsPLAwTX;
...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int wz3q8mIT = 2147483647;
  int qrPiKnlM = 2147483647;
  int Ti_7SpyV = 2147483647;
  foo(y.f0);
  printf("%d\n", y.f0.f0);
  if (wz3q8mIT)
    Ti_7SpyV |= qrPiKnlM;
  return 0;
  transparent_crc(Ti_7SpyV, "Ti_7SpyV", 1);
  transparent_crc(qrPiKnlM, "qrPiKnlM", 1);
  transparent_crc(wz3q8mIT, "wz3q8mIT", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
