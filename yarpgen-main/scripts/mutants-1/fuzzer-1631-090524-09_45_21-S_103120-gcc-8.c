...
// insert-switch-snippet -> insert-while-snippet -> insert-switch-snippet -> insert-for-snippet -> insert-for-snippet -> insert-for-snippet -> insert-switch-snippet -> insert-if-snippet -> insert-for-snippet

int numDigits(long unsigned int value)
{
  int Mc5R4HKa = -2147483648;
  int GUQtcvib = 2147483647;
  int n = 1;
  ...
  transparent_crc(GUQtcvib, "GUQtcvib", 1);
  transparent_crc(Mc5R4HKa, "Mc5R4HKa", 1);
...
int main()
{
  ...
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  for (q4Jr9X78 = 0; q4Jr9X78 >= 0; --q4Jr9X78)
  {
    int yt[8] = {0};
    int pz[2] = {0};
    int sa[32] = {0};
  ...
  transparent_crc(q4Jr9X78, "q4Jr9X78", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
