...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int DWYOhCtx = 1527639565;
  int pVP7fZa_ = -2147483648;
  char kYb1WJPx = (signed char)127;
  bar();
  pVP7fZa_ = DWYOhCtx / (~(kYb1WJPx | 114));
  printf("%d\n", b);
  transparent_crc(kYb1WJPx, "kYb1WJPx", 1);
  transparent_crc(pVP7fZa_, "pVP7fZa_", 1);
  transparent_crc(DWYOhCtx, "DWYOhCtx", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
