...
// insert-if-snippet -> insert-assignment-snippet -> insert-if-snippet -> insert-assignment-snippet -> insert-switch-snippet
...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int  _SyrfuiC = 2147483647;
  int * InvF9KqH = &_SyrfuiC;
  unsigned char hsSF12Hl = (unsigned char)127;
  ...
  transparent_crc(hsSF12Hl, "hsSF12Hl", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
