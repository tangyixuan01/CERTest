...
// insert-switch-snippet -> insert-switch-snippet -> insert-switch-snippet -> insert-assignment-snippet -> insert-for-snippet

signed char foo(unsigned char c2)
{
  long DZz5Q7Cf = 5012582462906723139LL;
  int KTNfnHwU = -2147483648;
  int uAkbPExe = 1272055248;
  unsigned HVhzCMKN = 3269655306U;
  int Ce6_qV7F = 669011263;
  ...
  HVhzCMKN = ~(-(KTNfnHwU || (uAkbPExe & DZz5Q7Cf)));
  bb21:
  ;
  ...
  transparent_crc(Ce6_qV7F, "Ce6_qV7F", 1);
  transparent_crc(HVhzCMKN, "HVhzCMKN", 1);
  transparent_crc(uAkbPExe, "uAkbPExe", 1);
  transparent_crc(KTNfnHwU, "KTNfnHwU", 1);
  transparent_crc(DZz5Q7Cf, "DZz5Q7Cf", 1);
...
int main()
{
  platform_main_begin();
  crc32_gentab();
  volatile int G5oUE0vz = -2147483648;
  int jueMNDC6 = 2147483647;
  ...
  transparent_crc(jueMNDC6, "jueMNDC6", 1);
  transparent_crc(G5oUE0vz, "G5oUE0vz", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
