...
// insert-switch-snippet -> insert-for-snippet -> insert-for-snippet -> insert-if-snippet -> insert-while-snippet -> insert-if-snippet
...
int main()
{
  platform_main_begin();
  crc32_gentab();
  unsigned short hf2Np4Z_ = (unsigned short)43466;
  int cGAx8sRv = -1130669591;
  unsigned short kQ2s0Emr = (unsigned short)14783;
  int y6M9RaXv = -2147483648;
  ...
  for (int i = 0; i < 16; ++i)
  {
    ...
    {
      tKC_PJ19 = NqSiCGhw;
      if (hf2Np4Z_ + (kQ2s0Emr * (~(0 != 5))))
        cGAx8sRv = (-(~(kQ2s0Emr * (~(0 != 5))))) + 2147483647;
      if (!NqSiCGhw)
        tKC_PJ19 = tKC_PJ19 / 2;
      kVwKG_PI = tKC_PJ19;
      RXVOS9kq = kVwKG_PI;
  ...
  transparent_crc(y6M9RaXv, "y6M9RaXv", 1);
  transparent_crc(kQ2s0Emr, "kQ2s0Emr", 1);
  transparent_crc(cGAx8sRv, "cGAx8sRv", 1);
  transparent_crc(hf2Np4Z_, "hf2Np4Z_", 1);
