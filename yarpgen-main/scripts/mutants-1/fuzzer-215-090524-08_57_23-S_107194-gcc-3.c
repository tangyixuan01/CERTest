...
// insert-switch-snippet -> insert-while-snippet -> insert-while-snippet -> insert-while-snippet
...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int EV9rtGql = -958561781;
  int oXjlTzQs = -1647129484;
  volatile unsigned  ZdhPejVf = 2728677036U;
  volatile unsigned * SUfDK95i = &ZdhPejVf;
  ...
  transparent_crc(oXjlTzQs, "oXjlTzQs", 1);
  transparent_crc(EV9rtGql, "EV9rtGql", 1);
