...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int z0Jso643 = 421629029;
  int CeSwXab3 = -2147483648;
  int QA1tvhsK = -2050665538;
  ...
  switch (yTUHK8Dc)
  {
    ...
    CeSwXab3 = (QA1tvhsK == 0) ? (z0Jso643) : (z0Jso643 / QA1tvhsK);
    default:
      *sevcZ7Fu = 0x05;
      break;
  ...
  transparent_crc(QA1tvhsK, "QA1tvhsK", 1);
  transparent_crc(CeSwXab3, "CeSwXab3", 1);
  transparent_crc(z0Jso643, "z0Jso643", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  walk(node, 1);
}
