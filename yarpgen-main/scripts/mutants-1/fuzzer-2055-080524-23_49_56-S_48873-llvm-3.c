...
void b()
{
  int zjIQq9at = -1351449466;
  int MYboTVLN = -810239894;
  char SQk0E1e3 = (signed char)127;
  int rQKzsTNu = 2147483647;
  int NIb8BcJH = -2147483648;
  ...
  transparent_crc(NIb8BcJH, "NIb8BcJH", 1);
  ...
  transparent_crc(rQKzsTNu, "rQKzsTNu", 1);
  transparent_crc(SQk0E1e3, "SQk0E1e3", 1);
  transparent_crc(MYboTVLN, "MYboTVLN", 1);
  transparent_crc(zjIQq9at, "zjIQq9at", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  for (; a <= 4; a++)
  {
    ;
