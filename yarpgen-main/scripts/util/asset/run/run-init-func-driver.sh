...
echo
echo "icc -O0"
icc -O0 init.h func.c driver.c -w -diag-disable=10441; ./a.out
echo
echo "icc -O1"
icc -O1 init.h func.c driver.c -w -diag-disable=10441; ./a.out
echo
echo "icc -O2"
icc -O2 init.h func.c driver.c -w -diag-disable=10441; ./a.out
echo
echo "icc -O3"
icc -O3 init.h func.c driver.c -w -diag-disable=10441; ./a.out
echo
echo "icc -Os"
icc -Os init.h func.c driver.c -w -diag-disable=10441; ./a.out
