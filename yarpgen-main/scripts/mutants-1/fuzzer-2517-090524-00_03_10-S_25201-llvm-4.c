...
// insert-for-snippet -> insert-if-snippet -> insert-switch-snippet -> insert-for-snippet -> insert-switch-snippet
...
{
  int nmdq_bcO = 2147483647;
  char m12MhaKZ = (signed char)127;
  ...
  transparent_crc(m12MhaKZ, "m12MhaKZ", 1);
  transparent_crc(nmdq_bcO, "nmdq_bcO", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  if (p1)
  {
    for (; nmdq_bcO; nmdq_bcO--)
      for (; m12MhaKZ >= 0; m12MhaKZ++)
      ;
...
int fn2()
{
  int  XJkBGVz3 = 1123419678;
  int * vZUxj4yg = &XJkBGVz3;
  unsigned char GwJyL768 = (unsigned char)48;
  ...
  transparent_crc(GwJyL768, "GwJyL768", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
