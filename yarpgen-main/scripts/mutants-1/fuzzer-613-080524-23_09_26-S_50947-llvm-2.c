...
int main()
{
  platform_main_begin();
  crc32_gentab();
  char BmVHZvkX = (signed char)127;
  int aToeqx6d = 2147483647;
  short J0TI9jAe = (short)10399;
  ...
  transparent_crc(J0TI9jAe, "J0TI9jAe", 1);
  transparent_crc(aToeqx6d, "aToeqx6d", 1);
  transparent_crc(BmVHZvkX, "BmVHZvkX", 1);
