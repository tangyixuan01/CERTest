...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int efFWnM_U = 2147483647;
  int ExzpuL5r = 1420461142;
  char DwuksYil = (signed char)-67;
  ...
  transparent_crc(DwuksYil, "DwuksYil", 1);
  transparent_crc(ExzpuL5r, "ExzpuL5r", 1);
  transparent_crc(efFWnM_U, "efFWnM_U", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  if (f)
  {
    __builtin_abort();
    efFWnM_U = ExzpuL5r % (DwuksYil + 1);
  }
}
