...
// insert-while-snippet -> insert-switch-snippet -> insert-for-snippet -> insert-if-snippet -> insert-assignment-snippet
...
{
  int HKGglOiz = 2147483647;
  short A0KE1IiF = (short)-32768;
  ...
  transparent_crc(A0KE1IiF, "A0KE1IiF", 1);
  transparent_crc(HKGglOiz, "HKGglOiz", 1);
