...
// insert-while-snippet -> insert-while-snippet -> insert-if-snippet -> insert-while-snippet
...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int V6sTMDjH = -2147483648;
  int WcQ2lNyZ = -1811187533;
  ...
  transparent_crc(WcQ2lNyZ, "WcQ2lNyZ", 1);
  transparent_crc(V6sTMDjH, "V6sTMDjH", 1);
