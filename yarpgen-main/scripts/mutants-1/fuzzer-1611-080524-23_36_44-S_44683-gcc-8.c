...
// insert-for-snippet -> insert-if-snippet -> insert-assignment-snippet -> insert-while-snippet -> insert-while-snippet -> insert-assignment-snippet -> insert-switch-snippet -> insert-switch-snippet -> insert-if-snippet

int copysign_bug(double x)
{
  int a3c4utUm = -1736421018;
  int rbzaE1GP = 2147483647;
  int lCATqwNM = 2147483647;
  ...
  transparent_crc(lCATqwNM, "lCATqwNM", 1);
  transparent_crc(rbzaE1GP, "rbzaE1GP", 1);
  transparent_crc(a3c4utUm, "a3c4utUm", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  if ((x * 0.5) == x)
  {
    return 1;
