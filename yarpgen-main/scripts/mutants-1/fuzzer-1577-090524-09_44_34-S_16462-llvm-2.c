...
{
  int unoS6fDe = 382034701;
  int MWS8oOZp = -2147483648;
  MWS8oOZp += unoS6fDe;
  transparent_crc(MWS8oOZp, "MWS8oOZp", 1);
  transparent_crc(unoS6fDe, "unoS6fDe", 1);
...
void fn3()
{
  char uHxNezcp = (signed char)-128;
  int OCuXEr2n = -2147483648;
  int *t = &d;
  transparent_crc(OCuXEr2n, "OCuXEr2n", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  uHxNezcp = ~OCuXEr2n;
  transparent_crc(uHxNezcp, "uHxNezcp", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  if (fn2(1) >= fn1(t == (&a[0])))
  {
    *c = 1;
