...
void foo()
{
  int OKefNs3F = -63195148;
  int bDtC_rfO = 1209722018;
  transparent_crc(bDtC_rfO, "bDtC_rfO", 1);
  transparent_crc(OKefNs3F, "OKefNs3F", 1);
...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int  O5pkFn6E = -2147483648;
  int * Do8hkGXn = &O5pkFn6E;
