...
// insert-assignment-snippet -> insert-assignment-snippet -> insert-assignment-snippet -> insert-assignment-snippet -> insert-assignment-snippet -> insert-assignment-snippet
...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int  jtXxrEZU = -1994491962;
  int * Cz4xvt0P = &jtXxrEZU;
  int  QmXczpSM = 2147483647;
  int * Aljx4caH = &QmXczpSM;
  int ** uI3XhrFA = &Aljx4caH;
  int *** iAp1jvJF = &uI3XhrFA;
  int **** BlmDCM7Y = &iAp1jvJF;
  int ***** PmZ39Ehy = &BlmDCM7Y;
  int TOS9CsJM = -502562592;
  ...
  *(*(*(*PmZ39Ehy))) = &TOS9CsJM;
  ...
  transparent_crc(TOS9CsJM, "TOS9CsJM", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  walk(node, 1);
}
