...
// insert-for-snippet -> insert-switch-snippet -> insert-assignment-snippet -> insert-switch-snippet -> insert-for-snippet -> insert-if-snippet
...
void fn1(int p1)
{
  int qyOxe_6a = 2147483647;
  char IlOJDNg0 = (signed char)-128;
  char Xp214xvZ = (signed char)117;
  int MLUFJqaQ = -1662978044;
  int Yy6b_s0g = 2147483647;
  ...
  if (MLUFJqaQ)
    qyOxe_6a = Yy6b_s0g < ((3 * (~IlOJDNg0)) + Xp214xvZ);
  ...
  *(*mdQvzgZY) = ((*h9BkUv3p) || ((ZlJUYW9T = &aOy8ng7s) == ((int *) (&euhyTVmF)))) == 0;
  ...
  transparent_crc(Yy6b_s0g, "Yy6b_s0g", 1);
  transparent_crc(MLUFJqaQ, "MLUFJqaQ", 1);
  transparent_crc(Xp214xvZ, "Xp214xvZ", 1);
  transparent_crc(IlOJDNg0, "IlOJDNg0", 1);
  transparent_crc(qyOxe_6a, "qyOxe_6a", 1);
...
{
  int UY5AtFOu = 2147483647;
  int UfSEo4kH = -2147483648;
  int  KGx6zYog = -965745480;
  int * cdzHO5ZK = &KGx6zYog;
  unsigned char IkgApDdZ = (unsigned char)0;
  fn2(p1);
  transparent_crc(IkgApDdZ, "IkgApDdZ", 1);
  transparent_crc(UfSEo4kH, "UfSEo4kH", 1);
  transparent_crc(UY5AtFOu, "UY5AtFOu", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  if (p3)
  {
    printf("%d\n", 5);
    ...
    for (; UY5AtFOu < 1; UY5AtFOu++)
      if ((!UfSEo4kH) && UfSEo4kH)
      ;
