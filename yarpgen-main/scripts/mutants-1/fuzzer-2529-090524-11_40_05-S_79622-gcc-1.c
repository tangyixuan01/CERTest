...
int main(void)
{
  platform_main_begin();
  crc32_gentab();
  int  VEYlL_aU = -2147483648;
  int * EGWckndS = &VEYlL_aU;
  unsigned char b_70zpVI = (unsigned char)254;
  ...
  transparent_crc(b_70zpVI, "b_70zpVI", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
