...
{
  int oOkfemih = -1201817717;
  int d7k6pcYO = -1746045219;
  int xEidljAS = -1200433134;
  ...
  transparent_crc(xEidljAS, "xEidljAS", 1);
  transparent_crc(d7k6pcYO, "d7k6pcYO", 1);
  transparent_crc(oOkfemih, "oOkfemih", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  while (*(s++))
  {
    while (d7k6pcYO > 6)
