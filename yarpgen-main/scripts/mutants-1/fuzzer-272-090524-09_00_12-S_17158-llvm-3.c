...
int main()
{
  platform_main_begin();
  crc32_gentab();
  unsigned char LUEAu5D9 = (unsigned char)255;
  short TSAlyr7F = (short)-32768;
  int _U3geDRi = -2147483648;
  int qcfHztBP = -2147483648;
  ...
  switch (A9M6pQjT)
  {
    ...
    qcfHztBP = ((_U3geDRi >= 2) || (1 >> _U3geDRi)) ? (0) : (_U3geDRi);
    case 0x81:
  ...
  transparent_crc(qcfHztBP, "qcfHztBP", 1);
  transparent_crc(_U3geDRi, "_U3geDRi", 1);
  transparent_crc(TSAlyr7F, "TSAlyr7F", 1);
  transparent_crc(LUEAu5D9, "LUEAu5D9", 1);
