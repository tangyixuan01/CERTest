...
int foo(struct X *x)
{
  long E58_RojK = 9223372036854775807LL;
  ...
  *y.p = 0;
  ...
  transparent_crc(E58_RojK, "E58_RojK", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return *y.p;
}
...
int main()
{
  platform_main_begin();
  crc32_gentab();
  int P4xrgG_K = -2147483648;
  int fkOP5_Dm = -1542661025;
  ...
  transparent_crc(fkOP5_Dm, "fkOP5_Dm", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  P4xrgG_K = (fkOP5_Dm < 0) || ((fkOP5_Dm >= 0) > fkOP5_Dm);
  transparent_crc(P4xrgG_K, "P4xrgG_K", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
