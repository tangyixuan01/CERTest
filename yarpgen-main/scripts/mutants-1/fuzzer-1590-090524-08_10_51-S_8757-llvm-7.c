...
// insert-switch-snippet -> insert-for-snippet -> insert-for-snippet -> insert-assignment-snippet -> insert-if-snippet -> insert-switch-snippet -> insert-switch-snippet -> insert-switch-snippet
...
{
  int * om2EAzrU = &g_62;
  unsigned char ZeKwONGa = (unsigned char)0;
  ...
  transparent_crc(ZeKwONGa, "ZeKwONGa", 1);
