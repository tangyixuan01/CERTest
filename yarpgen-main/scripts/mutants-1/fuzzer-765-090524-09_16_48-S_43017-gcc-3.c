...
{
  int ns6N3CW7 = 2147483647;
  int Z0PyvtTi = 2147483647;
  ...
  if ((c2 <= 63) || (c2 == 127))
  {
    for (Z0PyvtTi = 0; Z0PyvtTi < 5; Z0PyvtTi++)
      ns6N3CW7 = Z0PyvtTi * Z0PyvtTi;
  ...
  transparent_crc(Z0PyvtTi, "Z0PyvtTi", 1);
  transparent_crc(ns6N3CW7, "ns6N3CW7", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  bb43:
  return -1;
