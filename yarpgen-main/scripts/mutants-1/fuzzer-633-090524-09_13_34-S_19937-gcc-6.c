...
// insert-assignment-snippet -> insert-for-snippet -> insert-switch-snippet -> insert-assignment-snippet -> insert-switch-snippet -> insert-while-snippet -> insert-for-snippet
...
{
  int rEt8I7pS = 1491069941;
  int FBn5vI3M = 2147483647;
  ...
  while ((FBn5vI3M = sizeof(char [rEt8I7pS])) && (rEt8I7pS < 10))
  {
    printf("%d ", FBn5vI3M);
    rEt8I7pS++;
  }

  transparent_crc(FBn5vI3M, "FBn5vI3M", 1);
  transparent_crc(rEt8I7pS, "rEt8I7pS", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return flags;
}
...
int main(void)
{
  platform_main_begin();
  crc32_gentab();
  int8_t SEeICOvU = (signed char)-76;
  int rJs3yWmD = 2147483647;
  ...
  if (foo(".interp") == 0x10000)
  {
    ...
    abort();
    for (SEeICOvU = 1; SEeICOvU < 0; SEeICOvU = 1)
    {
    }
  ...
  transparent_crc(rJs3yWmD, "rJs3yWmD", 1);
  transparent_crc(SEeICOvU, "SEeICOvU", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  return 0;
}
