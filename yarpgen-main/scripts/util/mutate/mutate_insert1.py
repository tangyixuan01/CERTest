...
CODE_SNIPPETS_DIR = '/home/yixuan/compiler_testing-main-new/scripts/util/mutate/program'
...
def  adapt_code_snippet(snippet_str, snippet_variable2type, available_variable2type):
    ...
    print('available_type2variable:'+str(available_type2variable))
                ...
                with open(snippet_file_path, 'r') as f:
                    ...
                    if lines is not None and len(lines) < 2:
                        ...
                        if first_line.startswith('//'):
                            first_line = first_line[2:]
                            if first_line.strip() != '':
                                for variable_type in re.split(r'\s+', first_line.strip()):
                                # for variable_type in first_line.split(';'):
...
if __name__ == '__main__':
    '''
    snippet, snippet_vairable2type, snippet_file_path = select_code_snippet(CODE_SNIPPETS_DIR, 'for')
    print('snippet:'+'\n'+snippet+'\n'+'---------------'+'\n')
    print('snippet_vairable2type:'+'\n'+str(snippet_vairable2type)+'\n'+'---------------'+'\n')
    print('snippet_file_path:'+'\n'+snippet_file_path+'\n'+'---------------'+'\n')
