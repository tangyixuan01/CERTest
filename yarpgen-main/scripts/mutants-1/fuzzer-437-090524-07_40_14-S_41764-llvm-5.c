...
// insert-switch-snippet -> insert-switch-snippet -> insert-switch-snippet -> insert-switch-snippet -> insert-assignment-snippet -> insert-if-snippet
...
uint32_t o()
{
  ...
  transparent_crc(kziS9thG, "kziS9thG", 1);
