...
void fn1()
{
  long ciYoVzrN = 9052994831811158428LL;
  unsigned char n7scdkJw = (unsigned char)255;
  transparent_crc(n7scdkJw, "n7scdkJw", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  ciYoVzrN = ~((((~n7scdkJw) / 8) | (-2)) & 11007578330939886389LLU);
  transparent_crc(ciYoVzrN, "ciYoVzrN", 1);
  platform_main_end(crc32_context ^ 0xFFFFFFFFUL, 0);
  a = 1;
}
